...
export class EditproductComponent implements OnInit {
  ...
  deleteProduct() {
    console.log("product is",this.product.product);
    this._httpService.deleteProduct(this.product.product).subscribe(data => { //only need this.product instead of product passed in deleteproduct param since it's a global var already
